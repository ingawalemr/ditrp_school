<?php $this->load->view('header') ?>
    ...
    <section class="home-slider owl-carousel">
  	...
  	if (!empty($banner)) 
  	{
  		foreach ($banner as $b) { 
  			//print_r($b);
  			$path = 'http://localhost/ditrp_school/assets/images/'.$b['images'];
  			 ?>

  		  	<div class="slider-item" style="background-image:url(<?php echo $path; ?>);">
				<div class="overlay"></div>
				<div class="container">
				  	<div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
					  	<div class="col-md-8 text-center ftco-animate">
						    <h1 class="mb-4"><span><?php echo $b['banner_details']; ?></span></h1>
						    <p>
						    	<a href="#" class="btn btn-secondary px-4 py-3 mt-3">Read More</a>
						    </p>
					 	</div>
					</div>
				</div>
    ...
    <section class="ftco-services ftco-no-pb">
		...
		<section class="ftco-intro" style="background-image: url(<?php echo base_url() ?>assets/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-9">
            ...
            <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(<?php echo base_url() ?>assets/images/teacher-1.jpg);"></div>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(<?php echo base_url() ?>assets/images/teacher-2.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>Mitch Parker</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(<?php echo base_url() ?>assets/images/teacher-3.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>Stella Smith</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(<?php echo base_url() ?>assets/images/teacher-4.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
            ...
            <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
				...
				<div class="row">
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/course-1.jpg);"></div>
					...
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/course-2.jpg);"></div>
						<div class="text bg-light p-4">
					...
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/course-3.jpg);"></div>
						<div class="text bg-light p-4">
					...
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/course-4.jpg);"></div>
						<div class="text bg-light p-4">
    	...
    	<div class="container">
    		<div class="row justify-content-end">
	          ...
	          <form action="#" class="appointment-form ftco-animate">
		            ...
		            <div class="form-group ml-md-4">
		              <input type="submit" value="Enquiry" class="btn btn-secondary py-3 px-4">
		            </div>
	    				</div>
	    			</form>
    			</div>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Media</span> Gallery</h2>
            <!--<p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>-->
          </div>
        </div>
    		<div class="row">
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
	        		...
	        		<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/bg_1.jpg);"></div>
	        		<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        	...
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
	        		...
	        		<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/bg_2.jpg);"></div>
        			<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        	...
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light active pb-4 text-center">
	        		...
	        		<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/bg_3.jpg);"></div>
        			<div class="px-4">
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
        	...
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
	        		...
	        		<div class="img" style="background-image: url(<?php echo base_url() ?>assets/images/bg_5.jpg);"></div>
        			<div class="px-4">
	        			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        			</div>
		...
		<section class="ftco-section bg-light">
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="#" class="block-20 d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>assets/images/image_1.jpg);">
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="#" class="block-20 d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>assets/images/image_2.jpg);">
								<div class="meta-date text-center p-2">
                  <span class="day">27</span>
                  <span class="mos">January</span>
                  <span class="yr">2019</span>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="#" class="block-20 d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>assets/images/image_3.jpg);">
								<div class="meta-date text-center p-2">
                  <span class="day">27</span>
                  <span class="mos">January</span>
                  <span class="yr">2019</span>
